...

{
  environment.systemPackages = with pkgs; [
    ...
    ethtool unzip unrar rar zip xdg-utils rpi-imager solaar tcpdump
    nmap dnsutils socat sysstat atop iotop powertop ncdu tldr eww
    gnome-disk-utility whois
  ...
  programs.nix-ld.libraries = with pkgs; [
    ...
    # Dependências que o Chromium/Wavebox exige (X11 Fallback)
    xorg.libX11
    xorg.libXcursor
    xorg.libXrandr
    xorg.libXcomposite
